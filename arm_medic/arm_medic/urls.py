...
from patients import views as patients_views  # Исправлено: patients_views вместо patientsviews
...
urlpatterns = [
    ...
    # Пациенты
    path('patient/register/', patients_views.patient_register, name='patient_register'),
    path('patient/login/', patients_views.patient_login, name='patient_login'),
    path('patient/dashboard/', patients_views.patient_dashboard, name='patient_dashboard'),
